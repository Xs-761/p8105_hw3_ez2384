...
### Problem 2
  ...
  *  Load, tidy, merge, and otherwise organize the data sets.
     Exclusion of participants less than 21 yrs and those with missing demographc data.
...
```
  ...
  * Using your tidied dataset, aggregate acrss minutes to crea;te a total activity variable for each participant.
